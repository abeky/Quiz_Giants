...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        tmpArray.append(["ホームグラウンドの場所は？", "東京ドーム", "神宮球場", "秩父", 1])
        tmpArray.append(["ジャイアンツの選手は？", "阿部慎之助", "イチロー", "川崎宗則", 1])
        tmpArray.append(["ジャイアンツの監督は？", "原辰徳", "高橋由伸", "ラミレス", 2])
        tmpArray.append(["独身の選手は？", "田口", "大竹", "小林", 3])
        //------------------------ここから上にクイズを書く------------------------//
